...
// //revalidate basiaclly means that the page will be regenerated after the specified time, so if you set it to 5, it will regenerate the page every 5 seconds
